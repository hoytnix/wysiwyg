...
class ElementDict:
    def __init__(self, template):
        """Instantiable object to work with Templates."""

        # Debugging:
        #   This should actually be dependent on the global config.
        self.debug = True
        if self.debug:
            self.d_print = DebugPrint()
    ...
    def to_html(self):
        ...
        :param e_dict: Structure returned by self.element_dict().

        :output html: String representation of HTML.
        """
    ...
    def element_dict(self):
        ...
        rows = Element.query. \
            filter_by(template=self.template.id, parent=None). \
